 ...
 *
 * @wordpress-plugin
 * Plugin Name:   acf-service-post
 * Plugin URI:    http://yu2ahel.local/
 * Description:   acf-service-post
 * Version:       1
 * Author:        Ahmed wardany
 * Author URI:    http://yu2ahel.local/
 * Text Domain:   acf-service-post
  ...
  if( $featured_posts ){
      ...
      ';
       foreach( $featured_posts as $post ){
          ...
          $imgurl = get_field('main_image',$post->ID);
          
          // $featured_image_url = get_the_post_thumbnail_url($post->ID, 'full');
          $html .= '<a style="margin-top: 10px;" href="'.$permalink.'" class="banner" aria-label="Shop now">
          <div class="banner__grid">
            <div aria-hidden="true">
              <figure class="banner__figure" style="background-image: url('.$imgurl['url'].');"></figure>
            </div>
...
// register shortcode
add_shortcode('relatedServices', 'get_posts_services');